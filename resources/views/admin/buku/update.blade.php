                  ...
                  <div class="card-body">
                    ...
                    <form method="post" action="{{route('buku.update',$buku->id)}}">
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="Number" name="stok" class="form-control" id="exampleInputPassword1" value="{{$buku->stok}}">
                        </div>
                        <div class="mb-3 col-lg-6">
                            <label for="exampleInputPassword1" class="form-label">Harga</label>
                            <input type="Number" name="harga" class="form-control" id="exampleInputPassword1" value="{{$buku->harga}}">
                        </div>
