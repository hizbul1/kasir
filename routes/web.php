...
route::post('/buku/delete/{buku}',[BukuController::class,'destroy'])->name('buku.delete');
...
route::post('/pembeli/delete/{pembeli}',[PembeliController::class,'destroy'])->name('pembeli.delete');
...
route::post('/penjualan/delete/{penjualan}',[PenjualanController::class,'destroy'])->name('penjualan.delete');
